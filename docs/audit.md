...
| **S6** | DOM XSS via innerHTML (server/user data)            | 🟠       | ✅ **FIXED** `a2a9eb4` — shared `html-escape.js`, all sinks escaped, runtime-verified; renamed from `esc.js` (`2f51365`) to avoid ad-blocker filename match |
